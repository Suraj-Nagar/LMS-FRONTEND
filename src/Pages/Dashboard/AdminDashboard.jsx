...
function AdminDashboard() {
    ...
    const { allUsersCount, subscribedUserCount } = useSelector((state) => state.stat);
    ...
    const userData = {
        ...
        datasets: [
            {
                label: "user Details",
                data: [allUsersCount, subscribedUserCount],
            ...
            <div className="min-h-[90vh] pt-5 flex flex-col flex-wrap gap-10 text-white ">
                ...
                <div className="mx-[10%] w-[80%] flex flex-col items-center justify-center gap-10 mb-10 ">
                    <div className="flex w-full items-center justify-between">
                        ...
                        <button className="w-fit bg-yellow-500 hover:bg-yellow-600 transition-all ease-in-out duration-300 rounded-md py-2 px-4 font-semibold text-lg " onClick={() => navigate('/course/create')}> Create new course</button>
                    </div>
