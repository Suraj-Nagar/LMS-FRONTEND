            ...
            <div className="flex items-center justify-center h-[100vh] ">
                <form onSubmit={createNewAccount} noValidate className="flex flex-col justify-center gap-3 rounded-lg p-4 text-white w-96 shadow-[0_0_10px_black]">
                    ...
                    <div className="flex flex-col gap-1">
                        ...
                        <input type="text" className="bg-transparent px-2 py-1 border" required name="fullName" id="fullName" placeholder="Enter your fullName..." onChange={handleuserInput} value={signupData.fullName} />

                    </div>

                    <div className="flex flex-col gap-1">
                        <label htmlFor="email" className="font-semibold">Email</label>
                        <input type="email" className="bg-transparent px-2 py-1 border" required name="email" id="email" placeholder="Enter your email..." onChange={handleuserInput} value={signupData.email} />

                    </div>
                    <div className="flex flex-col gap-1">
                        <label htmlFor="password" className="font-semibold">Password</label>
                        <input type="password" className="bg-transparent px-2 py-1 border" required name="password" id="password" placeholder="Enter your password..." onChange={handleuserInput} value={signupData.password} />
                    </div>
